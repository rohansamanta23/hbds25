      ...
      <div className="w-full md:w-2/5 flex justify-center items-center mb-5 md:mb-0">
        <div className="relative group">
          ...
          <img
            src={image}
            alt={date}
            className="w-52 h-52 rounded-2xl object-cover shadow-lg border-4 border-white/80 group-hover:scale-105 transition-transform duration-300"
            style={{ background: "#f1d7fc" }}
            draggable={false}
            loading="lazy"
          />
...
const MemoryLaneSection: React.FC = () => (
  <section className="relative flex flex-col items-center justify-center min-h-[100vh] w-full py-20 px-2 z-10">
    <div className="flex flex-col items-center mb-8">
      ...
      <p className="text-lg md:text-xl text-fuchsia-900 bg-white/70 rounded-lg px-5 py-2 max-w-2xl shadow backdrop-blur-sm text-center">
